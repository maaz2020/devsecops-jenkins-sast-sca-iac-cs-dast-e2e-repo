pipeline {
  ...
  stages {
    ...
    stage('RunDASTUsingZAP') {
      steps {
        bat("C:\\devops\\zap\\ZAP_2.15.0_Crossplatform\\ZAP_2.15.0\\zap.sh -port 9393 -cmd -quickurl https://www.example.com -quickprogress -quickout C:\\zap\\ZAP_2.15.0_Crossplatform\\ZAP_2.15.0\\Output.html")
      }
    }
